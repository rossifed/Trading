...
namespace Quantaventis.Trading.Shared.Infrastructure.Modules
{
    public static class Extensions
    {
        ...
        public static IServiceCollection AddModuleGuiConnectors(this IServiceCollection services, IEnumerable<IModuleGuiConnector> moduleGuiConnectors)
        {
            foreach (var moduleGuiConnector in moduleGuiConnectors.OfType<IModuleGuiConnector>())
            {
                services.AddSingleton(typeof(IModuleGuiConnector), moduleGuiConnector);
            }
            services.AddSingleton<IList<IModuleGuiConnector>>(sp => sp.GetServices<IModuleGuiConnector>().ToList());
            return services;
        }
    }
}
