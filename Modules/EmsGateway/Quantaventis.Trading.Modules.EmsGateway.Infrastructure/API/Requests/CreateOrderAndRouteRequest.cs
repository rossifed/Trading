...
{
    public class CreateOrderAndRouteRequest : AbstractRequest<CreateOrderAndRouteResponse>
    {

        private EmsxOrder Order { get; }
        public CreateOrderAndRouteRequest(EmsxOrder order) : base("CreateOrderAndRoute")
        {
            this.Order = order;
        ...
        public override IResponseEventHandler<CreateOrderAndRouteResponse> CreateResponseHandler(IEmsxEventHandler messageEventDispatcher)
               => new CreateOrderAndRouteResponseHandler(messageEventDispatcher, this);
    }
}
