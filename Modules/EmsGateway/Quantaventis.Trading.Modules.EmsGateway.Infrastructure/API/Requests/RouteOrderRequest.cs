...
{
    public class RouteOrderRequest : AbstractRequest<RouteOrderResponse>
    {

        public Sequence Sequence { get; }
        public int Amount { get; }
        public string Broker { get; }
        public HandlingInstruction HandInstruction { get; }
        public OrderType OrderType { get; }
        public Ticker Ticker { get; }
        public TimeInForce TimeInForce { get; }

        public RouteOrderRequest(Sequence sequence,
            int amount,
            string broker,
            HandlingInstruction handInstruction,
            OrderType orderType,
            Ticker ticker,
            TimeInForce timeInForce) : base("RouteEx")
        {
            Sequence = sequence;
            Amount = amount;
            Broker = broker;
        ...
        public RouteOrderRequest(EmsxOrder emsxOrder) : this(
                emsxOrder.Sequence,
                emsxOrder.Amount,
                emsxOrder.Broker,
        ...
        public override IResponseEventHandler<RouteOrderResponse> CreateResponseHandler(IEmsxEventHandler messageEventDispatcher)
            => new RouteOrderResponseHandler(messageEventDispatcher, this);
