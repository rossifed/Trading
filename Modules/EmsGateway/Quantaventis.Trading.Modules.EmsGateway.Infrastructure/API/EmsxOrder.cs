...
{
    public class EmsxOrder
    {
        public EmsxOrder()
        {

        }
        public bool IsRoutable => Status == OrderStatus.NEW || Status == OrderStatus.ASSIGN;
        ...
        //public EmsxOrder(string orderRefid,Ticker ticker, int amount, Account account,  OrderType orderType, TimeInForce tif, HandlingInstruction handInstruction)
        //{
        ...
        {
            string str = $"Side: {Side}" + Environment.NewLine;
            str = str + $"Amount: {Amount}" + Environment.NewLine;
            str = str + $"Ticker: {Ticker}" + Environment.NewLine;
            str = str + $"OrderType: {OrderType}" + Environment.NewLine;
            str = str + $"OrderRefId: {OrderRefId}" + Environment.NewLine;
            str = str + $"Sequence: {Sequence}" + Environment.NewLine;
            str = str + $"Status: {Status}" + Environment.NewLine;
