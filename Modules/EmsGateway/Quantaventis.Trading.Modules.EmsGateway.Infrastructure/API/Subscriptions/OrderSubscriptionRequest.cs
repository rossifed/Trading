...
{
    public class OrderSubscriptionRequest : ISubscription<OrderSubscriptionResponse>
    {
        ...
        {
            String orderTopic = service.Name + "/order?fields=";
        ...
        public ISubscriptionEventHandler<OrderSubscriptionResponse> CreateSubscriptionEventHandler(CorrelationID correlationId, IEmsxEventHandler messageEventDispatcher, Action<CorrelationID, OrderSubscriptionResponse> onEventAction)
         => new OrderSubscriptionEventHandler(correlationId, messageEventDispatcher, onEventAction);
    }
}
