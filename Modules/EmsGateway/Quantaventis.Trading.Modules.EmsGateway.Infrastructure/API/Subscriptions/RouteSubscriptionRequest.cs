...
{
    public class RouteSubscriptionRequest : ISubscription<RouteSubscriptionResponse>
    {




        public RouteSubscriptionRequest()
        {
        ...
        public String CreateTopic(Service service)
        {
            String routeTopic = service.Name + "/route?fields=";
        ...
        public ISubscriptionEventHandler<RouteSubscriptionResponse> CreateSubscriptionEventHandler(CorrelationID correlationId, IEmsxEventHandler messageEventDispatcher, Action<CorrelationID, RouteSubscriptionResponse> onEventAction)
         => new RouteSubscriptionEventHandler(correlationId, messageEventDispatcher, onEventAction);
    }
}
